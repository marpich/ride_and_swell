...
equipment_kite_1 = Equipment.new(sport: "kite surf", brand: "Boardworks", user: user3, price: "55", description: "un petit plaisir en mer , utilise ce kite surf , un orgasme en mer", board_size: 2.05, sail_size: 12, title: "kite de fou je te promets", condition: "good", location: "La Baule")
...
equipment_kite_2 = Equipment.new(sport: "kite surf", brand: "Corsurf", user: user4, price: "50", description: "superbe planche franchement top pour mousser devant les filles à la plage", board_size: 2.08, sail_size: 9, title: "kite pour ce la raconter à la plage", condition: "medium", location: "Lacanau")
file = URI.open('https://res.cloudinary.com/dciokrtia/image/upload/v1653396924/kitesurf_lqn065.jpg')
equipment_kite_2.photo.attach(io: file, filename: 'kite2.png', content_type: 'image/png')
equipment_kite_2.save!

equipment_kite_3 = Equipment.new(sport: "kite surf", brand: "Decathlon", user: user1, price: "48", description: "je vous propose mon kite , je l'ai acheter mais je ne sais pas en faire donc je le loue ", board_size: 2.07, sail_size: 12, title: "kitesurf sympa", condition: "perfect", location: "St Malo")
file = URI.open('https://res.cloudinary.com/dciokrtia/image/upload/v1653396924/kitesurf_lqn065.jpg')
